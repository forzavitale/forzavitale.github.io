...
_R = average for the movie (mean) = (Rating)_\s\s
_v = number of votes for the movie = (votes)_\s\s
_m = minimum votes required to be listed in the Top 250_\s\s
_C = the mean vote across the whole report_\s\s
