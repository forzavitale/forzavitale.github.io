...
Here we examine data on the top 250 user-rated movies on IMDb.com to identify which factors are most helpful in predicting the user rating (or 'weighted rating'), which is calculated as follows:
