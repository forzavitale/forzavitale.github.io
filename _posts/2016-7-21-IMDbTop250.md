...
_R = average for the movie (mean) = (Rating)_<br/><br/>
_v = number of votes for the movie = (votes)_<br/><br/>
_m = minimum votes required to be listed in the Top 250_<br/><br/>
_C = the mean vote across the whole report_<br/><br/>
