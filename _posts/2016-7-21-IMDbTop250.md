...
_R = average for the movie (mean) = (Rating)_
_v = number of votes for the movie = (votes)_
_m = minimum votes required to be listed in the Top 250_
_C = the mean vote across the whole report_
